...
function showMeme() {
  ...
  const memeContaner= document.getElementById('xxx');
  memeContaner.innerHTML = '';
  ...
  title.textContent='here is your Meme!';
  memeContaner.appendChild(title);


  memeContaner.appendChild(newImg);
...
function showJoke() {
  ...
  const jokeContaner=document.getElementById('xxx');
  jokeContaner.innerHTML = '';

  const title=document.createElement('p');
  title.setAttribute('class','titleclass')
  title.textContent='here is your Joke!';
  jokeContaner.appendChild(title);

  const newJoke=document.createElement('p');
  newJoke.textContent=randomJokeText;
  jokeContaner.appendChild(newJoke);
...
function showQuote() {
  ...
  const quoteContaner=document.getElementById('xxx');
  quoteContaner.innerHTML = '';

  const title=document.createElement('p');
  title.setAttribute('class','titleclass')
  title.textContent='here is your Quote!';
  quoteContaner.appendChild(title);
  ...
  quoteContaner.appendChild(newQuote);
  quoteContaner.appendChild(author);
...
function showRiddle() {
  ...
  const riddleContaner=document.getElementById('xxx');

  const newRiddle=document.createElement('p');
  const answer=document.createElement('p');

  newRiddle.textContent=randomRiddle.question;
  newRiddle.setAttribute('id','questionID')

  answer.textContent="- " +randomRiddle.answer;
  answer.setAttribute('id','answerID')
  answer.hidden=true;

  riddleContaner.innerHTML = '';
  const title=document.createElement('p');
  title.setAttribute('class','titleclass')
  title.textContent='here is your Riddle!';
  riddleContaner.appendChild(title);


  riddleContaner.appendChild(newRiddle);
  riddleContaner.appendChild(answer);
...
function revealAnswers() {
  ...
  } else if(question&& !answer.hidden){
    alert( 'The answer is already revealed!')

  } else{

    alert( 'press Riddle me first!')
